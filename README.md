...
│   │
│   ├── ODE_heaviside/
│   │   └── test_cqrk_varn0ODERV.m       % Example 3 — ODE with Heaviside forcing
│   │
│   ├── conv_genKa/
...
| **Example 3** | Scalar ODE with Heaviside forcing | [`examples/ODE_heaviside/test_cqrk_varn0ODERV.m`](examples/ODE_heaviside/test_cqrk_varn0ODERV.m) |
